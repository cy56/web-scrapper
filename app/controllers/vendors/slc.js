...
exports.findByParams = (req, res) => {
    ...
    const attributes = ['id', 'source', 'date', 'currency', 'betAmount', 'winloss'];
    model.findAll({
...
exports.create = (obj) => {
    model.create({
        ...
        winloss: obj.winloss,
        comm: obj.comm,
        commAmount: obj.commAmount,
        totalAmount: obj.totalAmount,
        shareComm: obj.shareComm,
        totalShare: obj.totalShare,
        subTotal: obj.subTotal,
        vshareComm: obj.vshareComm,
        vshareTotal: obj.vshareTotal,
        vsubTotal: obj.vsubTotal
