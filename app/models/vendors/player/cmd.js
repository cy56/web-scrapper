...
class CMD extends Model {
    ...
    static getModelIndex() {
        return [
            {
                unique: true,
                fields: ['date', 'currency', 'source', 'brand', 'username']
            }
        ];
    }

    static getModelDefaultAttributes() {
        return ['id', 'source', 'date', 'currency', 'username', 'bets', 'stake', 'player_winloss'];
    }
    ...
    static getDatatableColumns() {
        return ['source', 'currency', 'date', 'currency', 'bets', 'stake', 'player_winloss'];
    }
    ...
    static getDatatableHeader() {
        return [
            ...
            { text: 'Username', value: 'username', sortable: true, align: 'left', width: "1%" },
